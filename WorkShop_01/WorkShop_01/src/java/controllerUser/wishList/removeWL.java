 ...
 * @author ADMIN
 */
@WebServlet(name = "removeWL", urlPatterns = {"/removeWL"})
public class removeWL extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        User.UserDTO user = (UserDTO) session.getAttribute("user");
